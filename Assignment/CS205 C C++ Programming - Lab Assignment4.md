...
#include <string>
using namespace std;
#define READ_FILE "lab_records.csv"
...
int main() {
    ...
    if (!file.good()) {
        cout<< READ_FILE <<" can not be opened." << endl;
        exit(0);
    }
    ...
    file.close();
    double total_average = (double )total / student_number / 14;
    cout<<"total average points are "<<total_average<<endl;
    for (int i = 0; i < 14; i++) {
        double average = (double)lab[i] / student_number;
        if (average < total_average) {
            cout << "lab" << i+1 << " "<<average<<endl;
        }
    }
    return 0;
}
...
```
total average points are 2.63095
lab1 2.08333
lab4 2.41667
lab5 2.33333
lab6 1.75
